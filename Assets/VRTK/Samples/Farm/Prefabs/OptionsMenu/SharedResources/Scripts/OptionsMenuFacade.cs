namespace VRTK.Examples.Prefabs.OptionsMenu
{
    ...
    public class OptionsMenuFacade : MonoBehaviour
    {
        ...
        public virtual void SetLocation()
        {
            ...
            {
                transform.position = new Vector3(locationDirectionPosition.x, locationTargetPosition.y - 1.5f, locationDirectionPosition.z);
            }
            else if (player.transform.localScale.x > 1f)
            {
                transform.position = new Vector3(locationDirectionPosition.x, locationTargetPosition.y - 3f, locationDirectionPosition.z);
            }
            else if (player.transform.localScale.x < 1f)
            {
                transform.position = new Vector3(locationDirectionPosition.x, locationTargetPosition.y - 0.2f, locationDirectionPosition.z);
            }
